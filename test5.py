...
target_image_path = '/workspace/home/yuanrt/ControlNet1_1/ControlNet-v1-1-nightly/dataForTrain/resultData/cropped_1_bag.png'
target_image = cv2.imread(target_image_path)

control = torch.tensor([[-2]], requires_grad = True, dtype=torch.float32)#.cuda()
