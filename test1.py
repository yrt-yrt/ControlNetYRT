...
#加了一个control_num_str
def process(input_image, control_num_str, prompt, a_prompt, n_prompt, num_samples, image_resolution, ddim_steps, guess_mode, strength, scale, seed, eta, denoise_strength):
    global preprocessor
...
with block:
    ...
    with gr.Row():
        with gr.Column():
            ...
            control_num_str = gr.Textbox(label="Control_num_str")   #有改动2
    ...
    #加了一个control_num_str        
    ips = [input_image, control_num_str, prompt, a_prompt, n_prompt, num_samples, image_resolution, ddim_steps, guess_mode, strength, scale, seed, eta, denoise_strength]
